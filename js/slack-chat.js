...
(function( $ ) {
	...
	var methods = {
		init: function (options) {
			this._defaults = {
                apiToken: 'xoxp-5085511200-5085511238-5085643346-344d66',		//#Slack token
	            channelId: 'C06MKSA2K',		//#Slack channel ID
	            user: 'Anonymous Web Person',			//name of the user
	            ...
	            sysUser: 'Anonymous Black Person',
	            queryInterval: 3000,
	            chatBoxHeader: "Hi, ask me anything. How may I help you?",
	            slackColor: "#333",
	            messageFetchCount: 100,
	            botUser: 'Anonymous Person',		//username to post to #Slack
	            sendOnEnter: true,
	            disableIfAway: false,
			...
			html += '<textarea class="form-control slack-new-message" type="text" placeholder="Ask a question."></textarea>';
